...
func newRequest(urlStr string, bts []byte) ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("post fail,%v", err)
	}
...
func NewOrder(urlStr string, request OrderRequest) (*Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("unmarshal resonse[%s] fail,%v",resp, err)
	}
	return r, err
}
...
func NewCancel(urlStr string, request CancelRequest) ([]*Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("unmarshal resonse[%s] fail,%v",bts, err)
	}
	return r, err
}
...
func SearchOrder(urlStr string, request QueryRequest) (*QueryRsp, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("unmarshal resonse[%s] fail,%v",b, err)
	}
